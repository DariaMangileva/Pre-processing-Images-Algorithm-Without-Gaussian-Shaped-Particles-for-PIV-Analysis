...
def main(file):
    ...
    for time_step in range(args.first, args.last + 1, args.step):
        ...
        return pp
N = []
mass = os.listdir('./nc_canny')
for i in tqdm(range(len(mass))):
    main('./nc_canny/{n}.nc'.format(n = i))
    N.append(pp)
    # except ValueError:
    #    continue
#x = list(range(len(N)))
...
N0 = []
mass0 = os.listdir('./nc')
for i in tqdm(range(len(mass0))):
    main('./nc/{n}.nc'.format(n = i))
    N0.append(pp)
    # except ValueError:
    #    continue
#x = list(range(len(N)))
...
N02 = []
mass0 = os.listdir('./nc_sobel')
for i in tqdm(range(len(mass0))):
    main('./nc_sobel/{n}.nc'.format(n = i))
    N02.append(pp)
    # except ValueError:
    #    continue
#x = list(range(len(N)))
...
N03 = []
mass0 = os.listdir('./nc_raw')
for i in tqdm(range(len(mass0))):
    main('./nc_raw/{n}.nc'.format(n = i))
    N03.append(pp)
    # except ValueError:
    #    continue
#x = list(range(len(N)))
